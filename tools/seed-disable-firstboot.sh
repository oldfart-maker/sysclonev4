...
# BOOT might not exist on some images; mount best-effort
...
mask_unit() {
  local name="$1" link="$ROOT_MOUNT/etc/systemd/system/$name"
...
# Mask any *.service referencing firstboot/oem/setup
...
# Remove getty inject points & profile hooks; stub common binaries
